...
|---|---|---|
| S-01 Reset teaching plan | Open War → Practice siege. **Do not redraw.** Tap **Try this plan**. | **FORT TAKEN**. Losses **5 / 5 / 4** (rendered as `Vanguard 5 of 18 · Archers 5 of 14 · Riders 4 of 10` from the headline slice on; the 2026-09-11 PASS frame shows the older bare numbers). `Why: The gate opened, 3 squads got inside, and 28 attackers reached the keep doors.` `Defenders: 43 of 43 fell.` Gate opens. All three squads enter through the open gate. Outcome line: `Training only. Your city troops and stock did not change.` |
...
| S-03 No-gate-team failure | From the teaching drawings (Reset if needed). Tap **Try without a gate team**. Do not redraw. Submit. | Status after the tap says the teaching routes loaded with only Vanguard's target changed. Banner: `No squad is opening the gate. Crossing the gate mark is not enough.` **FORT HELD**. Card shows `Why: No squad was sent to open the gate, so every squad was stopped at the wall.`, losses **Vanguard 8 of 18 · Archers 7 of 14 · Riders 5 of 10**, and `Defenders: 10 of 43 fell.` Reasons include `No squad was sent to open the gate` and three `reached the gate at x 50, but no squad was sent to open it` wall lines **even though the lines still cross x 50**. (Before the `headline` slice these read `closed or missed`; that copy is gone.) |
