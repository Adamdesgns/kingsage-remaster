...
**Artifact counts (revision 2, so the summary matches the tables):** §2 holds **63 feature rows** (A 4 · B 11 incl. B10a/B10b · C 9 · D 4 · E 12 · F 9 · G 5 · H 9); §3 holds **12 practice rows** (S-01…S-10, G-01, G-02); §4 holds **10 decision lines**, of which 1 is RESOLVED and 1 is OPEN design review, the rest DECISION-HELD. Rows carrying a **current-tip live PASS: 2** (S-10 on `0b7a34a`; B10a on `38610e0`, revision 3). Rows carrying a **VERIFIED LIVE that is historical only: 10** (A1, A2, B1, B6, B7, C1, C2, E10, F6, G1) — none of them certifies `9b478db`. Everything else Studio- or device-dependent is NOT RUN.
