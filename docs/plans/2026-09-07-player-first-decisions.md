...
|---|---|---|---|---|
| G-01 Practice understanding | **Open.** 2026-09-11: S-01 Studio Play PASS on `41d541e` / iPhone XR emulator (FORT TAKEN, 5 / 5 / 4, training-only line) after **Adam-assisted navigation** — not an independent bot PASS. Code tip is now `bdcef2e` (PR #8); live S-07 / S-03 on that tip, physical phone (S-09), and unfamiliar-player study were not run. Do not close from S-01 alone. Green automated gates do not start Phase 2. G-02 is a written Adam contract, not an emulator pass. | Phase 1 engineering/playtest owner | Phase 2 opening implementation | D-06 and D-13: correct entry teaching; three routes; accepted/rejected plans; reset/retry; meaningful success/failure; route-causality proof; real phone and unfamiliar-player evidence |
| G-02 Opening design contract | **Open. Adam-written answers only — not an emulator pass.** Silence is not approval. Green automated gates and a Studio S-07 / S-03 do not start Phase 2. Asks: `docs/plans/2026-09-10-opening-decisions-for-adam.md`. | Adam + Phase 2 engineering owner | Phase 2 persistence/tutorial build | D-01, D-02, D-08, D-09, D-10: reviewed opening spec, exact budget/unlocks, one-time grants, shield contract, fresh admission, migration and return-session behavior |
