...
|---|---|---|---|---|
| G-01 Practice understanding | **Open.** 2026-09-11: S-01 Studio Play PASS on `41d541e` / iPhone XR emulator (FORT TAKEN, 5 / 5 / 4, training-only line). S-03+, physical phone, and unfamiliar-player study were not run. Do not close from S-01 alone. | Phase 1 engineering/playtest owner | Phase 2 opening implementation | D-06 and D-13: correct entry teaching; three routes; accepted/rejected plans; reset/retry; meaningful success/failure; route-causality proof; real phone and unfamiliar-player evidence |
